...
@section('content')
 <form method="POST" action="{{ route('make-pdf') }}">
    @csrf
            ...
            <div class="content-wrapper">
                ...
                <div class="box col-md-12 mx-auto py-2"> 
                    ...
                    <div class="box-body   p-1"> 
                        <h5 class="mb-2"> <strong>Agreed & Accepted By :</strong> </h5>
                        ...
                        <div class="row">
                            <div class="col"> 
                                 ...
                                 <div class="mt-1">
                                    @foreach($residential_value as $rows)
                                    <strong>Residential : </strong>
                                    <input type="text" name="residential-value" value="{{$rows->type_name}}" class="form-control form-sm border-top-0 border-left-0 border-right-0 rounded-0">  
                                    @endforeach
                                </div>
                                ...
                                <div class="mt-1">
                                    ...
                                    @foreach($scopes as $s)
                                    <input type="text" name="scope-of-work" value="{{ $s->work_description .' $'.$price }}" class="form-control form-sm border-top-0 border-left-0 border-right-0 rounded-0">
