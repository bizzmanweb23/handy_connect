...
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border d-flex">
                                    ...
                                    @can('assign_sales_person')
                                        <div class="ml-2">
                                            <a href="#!"
                                                onclick="open_field_modal('assign_sales_person_modal','add_assign_sales_person_form')"
                                    ...
                                    @endcan
                                    @can('assign_field_verification')
                                        <div class="ml-2">
                                            <a href="#!"
                                                onclick="open_field_modal('assign_field_employee','add_field_employee_form')"
                                                class="btn btn-primary btn-sm">
                                                <i class="fa fa-plus"></i>
                                                Field verification
                                            </a>
                                    ...
                                    @can('create.quotation')
                                        <div class="ml-2">
                                            <a href="{{ URL::signedRoute('admin.admin_quotation.show', request()->id) }}"
                                                class="btn btn-primary btn-sm">
                                                <i class="fa fa-plus"></i>
                                                New Quotation
                                            </a>
                                    ...
                                    <div class="ml-2">
                                        <a href="{{ URL::signedRoute('admin.quotation_list', $data->id) }}"
                                            class="btn btn-primary btn-sm">
                                            <i class="fa fa-plus"></i>
                                            Show Quotation
                                        </a>
                                    ...
                                    <div class="box-header d-flex">
                                        ...
                                        <div class="box-tools float-right">
                                            <a class="btn btn-soft-success  btn-icon btn-circle btn-sm"
                                                href="{{ URL::signedRoute('admin.crm.edit', $data->id) }}"
                                                data-toggle="tooltip" title="{{ __('role.edit') }}"> <i
    ...
    {{-- assign to sales person --}}
    <div class="modal fade text-left" id="assign_sales_person_modal" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel1">Assign Sales Person </h3>
                    <button type="button" class="close rounded-pill" data-dismiss="modal" aria-label="Close">
                        <i class="bx bx-x"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="add_assign_sales_person_form">
                        @csrf
                        <label>@lang('employee.employee') @lang('role.name'): </label>
                        <div class="form-group">
                            <select name="sales_person_id" class="form_control" id="sales_person_list">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary ml-1" id="add_assign_sales_person_form_btn">
    ...
    {{-- end assign to sales person --}}

    {{-- modal --}}
    <div class="modal fade text-left" id="assign_field_employee" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@section('javascript')
    <script>
        ...
        $('#add_assign_sales_person_form_btn').click(function() {
            var form = $('#add_assign_sales_person_form')[0];
            var data = new FormData(form);
            data.append('crm_id', "{{ request()->id }}")
            $.ajax({
                url: "{{ URL::signedRoute('admin.crm.assign_sales_person') }}",
                type: 'post',
                data: data,
                dataType: 'json',
                cache: false,
                ...
                beforeSend: function(data) {
                    show_when_ajax_call('#add_assign_sales_person_form_btn',
                        'add_assign_sales_person_form')
                },
                success: function(data) {
                    console.log(data)
                    if (data.status == 'success') {
                        remove_after_ajax_call('#add_assign_sales_person_form_btn',
                            'add_assign_sales_person_form',
                        )
                ...
                error: function(error) {
                    console.log(error)
                    show_errors_when_ajax_call('#add_assign_sales_person_form_btn',
                        'add_assign_sales_person_form',
                        error,
                    )
                }
        ...
        function get_sales_person() {
            $.ajax({
                url: "{{ URL::signedRoute('admin.employee.sales_person_list') }}",
                type: 'get',
                dataType: 'json',
                success: function(data) {
                    console.log(data);
                    $('#sales_person_list').empty();
                    $('#sales_person_list').append('<option value="">--Select--</option>');
                    ...
                    if ("{{ !empty($data->assign_sales_person) }}") {
                        var vendor = "{{ $data->assign_sales_person }}";
                        $('#sales_person_list').select2('val', vendor);
                    }
