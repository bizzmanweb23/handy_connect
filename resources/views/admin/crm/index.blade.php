                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row flex-row flex-sm-nowrap" style="overflow-x: scroll">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-xl-3 box" style="margin: 20px"
                                            id="get_assign_sales_person">
                                            <h4>Assign Sales Person </h4>
                                            {{-- <div class=" box box-primary">
                                            <div class="box-body">
                                                <a href="">
...
@section('javascript')
    <script>
        ...
        function get_crm_data() {
            $.ajax({
                url: "{{ URL::signedRoute('admin.crm.get_admin_crm_data') }}",
                type: 'get',
                dataType: 'json',
                beforeSend: function() {
                    $('#main_loader').show()
                ...
                success: function(data) {
                    ...
                    var len = data.length;
                    for (var i = 0; i < len; i++) {
                        var url = "{{ route('admin.crm.show_crm', ':id') }}";
                        ...
                        if (data[i]['stage'] == 2) {
                            $('#get_assign_sales_person').append('<a href="' + url + '">' +
                                '<div class="box box-primary">' +
                                '<div class="box-body">' +
                                '<strong>' + data[i]['crm_unique_id'] + '</strong><br>' +
                                '<strong>' + data[i]['name'] + '</strong><br>' +
