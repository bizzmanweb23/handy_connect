                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title titlefix">@lang('customer.customers')</h3>
                                    @can('customer.add')
                                ...
                                <div class="box-body">
                                    ...
                                    <table class="" id="customer_list" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Unique Id</th>
                                                <th>Customer Type</th>
...
@section('javascript')
    <script>
        $(document).ready(function() {
            user_list = $('#customer_list').DataTable({
                "aaSorting": [],
                ...
                ajax: {
                    url: "{{ route('admin.customer.customer_list') }}",
                    type: 'get',
