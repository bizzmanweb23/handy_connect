...
<body>
                ...
                <div class="container-fluid clearfix">
                    <div class="outer-box clearfix">
                        <div class="header-upper-left">
                            <div class="logo">
                                <a href="{{ route('index') }}"><img src="{{ asset('frontend/images/logo.png') }}"
                    ...
                    <div class="clearfix">
                        ...
                        <div class="logo float-left">
                            <a href="{{ route('home') }}" class="img-responsive"><img
                                    src="{{ asset('frontend/images/logo.png') }}" alt="" title=""></a>
                        </div>
                        <!--Right Col-->
                            ...
                            <ul class="recent-news">
                                <li>
                                    <div class="img-holder">
                                        <img src="{{ asset('frontend/images/footer/recent-news-1.jpg') }}"
                                            alt="Awesome Image">
                                ...
                                <li>
                                    <div class="img-holder">
                                        <img src="{{ asset('frontend/images/footer/recent-news-2.jpg') }}"
                                            alt="Awesome Image">
                                        <div class="overlay-style-one bg1">
                                            <div class="box">
                                                <div class="content">
    ...
    <script src="{{ asset('frontend/language-switcher/jquery.polyglot.language.switcher.js') }}"></script>
    <script src="{{ asset('frontend/timepicker/timePicker.js') }}"></script>
    <script src="{{ asset('frontend/html5lightbox/html5lightbox.js') }}"></script>
    ...
    <script src="{{ asset('frontend/plugins/revolution/js/extensions/revolution.extension.actions.min.js') }}">
    </script>
    <script src="{{ asset('frontend/plugins/revolution/js/extensions/revolution.extension.carousel.min.js') }}">
    </script>
    <script src="{{ asset('frontend/plugins/revolution/js/extensions/revolution.extension.kenburn.min.js') }}">
    </script>
    <script src="{{ asset('frontend/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}">
    </script>
    <script src="{{ asset('frontend/plugins/revolution/js/extensions/revolution.extension.migration.min.js') }}">
    </script>
    <script src="{{ asset('frontend/plugins/revolution/js/extensions/revolution.extension.navigation.min.js') }}">
    </script>
    <script src="{{ asset('frontend/plugins/revolution/js/extensions/revolution.extension.parallax.min.js') }}">
    </script>
    <script src="{{ asset('frontend/plugins/revolution/js/extensions/revolution.extension.slideanims.min.js') }}">
    </script>
